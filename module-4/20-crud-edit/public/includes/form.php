<form action="<?php htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="border border-secondary-suble rounded shadow-sm p-3">
    ...
    <div class="mb-4">
        ...
        value="<?= htmlspecialchars($_POST['city_name'] ?? ($city['city_name'] ?? '' )) ?>" >
    ...
    <div class="mb-4">
        ...
        <input type="text" name="population" id="population" class="form-control" value="<?= htmlspecialchars($_POST['population'] ?? ($city['population'] ?? '' )) ?>">
    ...
    <div class="mb-4">
        ...
        <input type="text" name="trivia" id="trivia" class="form-control" value="<?= htmlspecialchars($_POST['trivia'] ?? ($city['trivia'] ?? '' )) ?>">
